...
/*        var ASD = [];
        ...
        ASD = JSON.parse(localStorage.getItem('FirstName'))?JSON.parse(localStorage.getItem('FirstName')):[]

        ASD.push(FirstName);
        localStorage.setItem('FirstName',JSON.stringify(ASD));
*/
    ...
    // document.getElementById('exampleInputlfiled').value = undefined;
    // document.getElementById('inlineRadio1').value = undefined;
